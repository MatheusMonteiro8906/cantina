...
class CheckoutService
{
    ...
    function sendPaymentEmail($status, $amount, $name, $currency, $email, $country, $paymentType, $recipientArr)
    {
        require_once __DIR__ . '/../../vendor/phpmailer/phpmailer/src/PHPMailer.php';
        require_once __DIR__ . '/../../vendor/phpmailer/phpmailer/src/Exception.php';
        require_once __DIR__ . '/../../vendor/phpmailer/phpmailer/src/SMTP.php';
        ...
        require_once __DIR__ . '/../resource/mail/payment-confirmation.php';
        $emailBodyHtml = getPaymentBody($status, $amount, $name, $currency, $email, $country, $paymentType);
        // set the recipient (To email address) generally the admin
        ...
        $mail->isHTML(true);
        $mail->Subject = Config::PAYMENT_CONFIRMATION_EMAIL_SUBJECT;
        $mail->Body = $emailBodyHtml;
        $replyToEmail = Config::SENDER_EMAIL;
        $replyToName = Config::SENDER_NAME;
        $mail->setFrom(Config::SENDER_EMAIL, Config::SENDER_NAME);
    ...
    function PaymentFailureMail($status, $amount, $name, $currency, $email, $country, $paymentType, $recipientArr, $recipientCCArr = Config::CC_EMAIL, $recipientBCCArr = Config::BCC_EMAIL)
    {
        require_once __DIR__ . '/../../vendor/phpmailer/phpmailer/src/PHPMailer.php';
        require_once __DIR__ . '/../../vendor/phpmailer/phpmailer/src/Exception.php';
        require_once __DIR__ . '/../../vendor/phpmailer/phpmailer/src/SMTP.php';
        ...
        require_once __DIR__ . '/../resource/mail/payment-failure-notification.php';
        $emailBodyHtml = getPaymentFailureBody($status, $amount, $name, $currency, $email, $country, $paymentType);
        ...
        $mail->isHTML(true);
        $mail->Subject = Config::PAYMENT_FAILURE_SUBJECT;
        $mail->Body = $emailBodyHtml;
        $replyToEmail = Config::SENDER_EMAIL;
        $replyToName = Config::SENDER_NAME;
        $mail->setFrom(Config::SENDER_EMAIL, Config::SENDER_NAME);
